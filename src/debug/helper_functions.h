...
#include_next <debug/helper_functions.h>
#else
...
namespace __gnu_debug
{
	...
	{
		return !std::__is_constant_evaluated() && __gnu_debug::__check_singular_aux(std::__addressof(__x));
	}
	...
	__valid_range_aux(_InputIterator __first, _InputIterator __last,
					  std::input_iterator_tag)
	{
		return __first == __last || (!__gnu_debug::__check_singular(__first) && !__gnu_debug::__check_singular(__last));
	}
	 ...
	 */
	template <typename _Iterator>
	_GLIBCXX_CONSTEXPR inline _Iterator
