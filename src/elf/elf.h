...
/* Types for signed and unsigned 16-bit quantities.  */
...
typedef Elf16_Half Elf16_Versym;
...
typedef struct
{
  Elf16_Sword	d_tag;			/* Dynamic entry type */
  union
    {
      Elf16_Word d_val;			/* Integer value */
      Elf16_Addr d_ptr;			/* Address value */
    } d_un;
} Elf16_Dyn;
