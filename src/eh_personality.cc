...
{
  const _uleb128_t *e = ((const _uleb128_t *)info->TType) - filter_value - 1;
                      ...
                      __attribute__((__unused__)))
{
  ...
  ue_header->barrier_cache.bitpattern[2] = (_uw)language_specific_data;
...
{
  const _Unwind_Word *e = ((const _Unwind_Word *)info->TType) - filter_value - 1;
...
#define PERSONALITY_FUNCTION __gxx_personality_v0
...
#endif
  {
    ...
    case _US_UNWIND_FRAME_STARTING:
      ...
      if (!(state & _US_FORCE_UNWIND) && ue_header->barrier_cache.sp == _Unwind_GetGR(context,
                                                                                      UNWIND_STACK_REG))
