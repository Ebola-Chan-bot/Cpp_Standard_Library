...
namespace std _GLIBCXX_VISIBILITY(default)
{
      ...
      class basic_string
      {
            ...
            static_assert(is_trivially_copyable_v<_CharT> && is_trivially_default_constructible_v<_CharT> && is_standard_layout_v<_CharT>);
      ...
      private:
            ...
            _S_allocate(_Char_alloc_type &__a, size_type __n)
            {
                  ...
                  if _GLIBCXX17_CONSTEXPR (!is_same_v<_Traits, char_traits<_CharT>>)
            ...
            struct __sv_wrapper
            {
                  _GLIBCXX20_CONSTEXPR explicit __sv_wrapper(__sv_type __sv) noexcept : _M_sv(__sv) {}
      ...
      public:
            ...
            _GLIBCXX20_CONSTEXPR explicit basic_string(const _Tp &__t, const _Alloc &__a = _Alloc())
...
#pragma GCC diagnostic ignored "-Wc++17-extensions"
            template <class _InputIterator,
                      typename = std::_RequireInputIter<_InputIterator>>
            _GLIBCXX20_CONSTEXPR basic_string &
            assign(_InputIterator __first, _InputIterator __last)
            {
                  using _IterTraits = iterator_traits<_InputIterator>;
                  if _GLIBCXX17_CONSTEXPR (is_pointer<decltype(std::__niter_base(__first))>::value && is_same<typename _IterTraits::value_type,
                                                                                                              _CharT>::value)
                  {
...
#if __cplusplus >= 202002L
                  else if _GLIBCXX17_CONSTEXPR (contiguous_iterator<_InputIterator> && is_same_v<iter_value_t<_InputIterator>,
                                                                                                 _CharT>)
                  {
                        __glibcxx_requires_valid_range(__first, __last);
                        return _M_replace(size_type(0), size(),
...
#pragma GCC diagnostic pop
      ...
      public:
             ...
             *  happen.
             */
            _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const _CharT *
             ...
             */
            _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR _CharT *
            data() noexcept
            {
                  return _M_data();
            }
             ...
             */
            _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR int
...
namespace std _GLIBCXX_VISIBILITY(default)
{
      ...
      _GLIBCXX20_CONSTEXPR inline _Str
       ...
       */
      template <typename _CharT, typename _Traits, typename _Alloc>
      _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline basic_string<_CharT, _Traits, _Alloc>
      ...
      template <typename _CharT, typename _Traits, typename _Alloc>
      _GLIBCXX20_CONSTEXPR inline basic_string<_CharT, _Traits, _Alloc>
      operator+(const basic_string<_CharT, _Traits, _Alloc> &__lhs,
      ...
      template <typename _CharT, typename _Traits, typename _Alloc>
      _GLIBCXX_NODISCARD _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline basic_string<_CharT, _Traits, _Alloc>
      operator+(const _CharT *__lhs,
                basic_string<_CharT, _Traits, _Alloc> &&__rhs)
      {
            return std::move(__rhs.insert(0, __lhs));
...
#define _GLIBCXX_STRING_CONSTEXPR
                  ...
                  _GLIBCXX_DEFAULT_ABI_TAG _GLIBCXX_STRING_CONSTEXPR inline basic_string<char>
                  operator""s(const char *__str, size_t __len)
                  {
                        return basic_string<char>{__str, __len};
                  }

                  _GLIBCXX_DEFAULT_ABI_TAG _GLIBCXX_STRING_CONSTEXPR inline basic_string<wchar_t>
...
#ifdef _GLIBCXX_USE_CHAR8_T
                  _GLIBCXX_DEFAULT_ABI_TAG _GLIBCXX_STRING_CONSTEXPR inline basic_string<char8_t>
