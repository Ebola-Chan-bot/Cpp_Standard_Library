...
#include_next <bits/predefined_ops.h>
#else
...
namespace __gnu_cxx
{
  namespace __ops
  {
    ...
    template <typename _Compare>
    _GLIBCXX20_CONSTEXPR inline _Iter_comp_val<_Compare>
    ...
    struct _Val_comp_iter
    {
      ...
      _GLIBCXX20_CONSTEXPR
      explicit _Val_comp_iter(_Compare __comp)
          : _M_comp(_GLIBCXX_MOVE(__comp))
      {
      }
    ...
    template <typename _Value>
    _GLIBCXX20_CONSTEXPR inline _Iter_equals_val<_Value>
    ...
    struct _Iter_equals_iter
    {
      ...
      _GLIBCXX20_CONSTEXPR
      explicit _Iter_equals_iter(_Iterator1 __it1)
          : _M_it1(__it1)
      {
      }
    ...
    template <typename _Iterator>
    _GLIBCXX20_CONSTEXPR inline _Iter_equals_iter<_Iterator>
    ...
    template <typename _Predicate>
    _GLIBCXX20_CONSTEXPR inline _Iter_pred<_Predicate>
    ...
    struct _Iter_negate
    {
      ...
      _GLIBCXX20_CONSTEXPR
      explicit _Iter_negate(_Predicate __pred)
          : _M_pred(_GLIBCXX_MOVE(__pred))
      {
      }
    ...
    template <typename _Predicate>
    _GLIBCXX20_CONSTEXPR inline _Iter_negate<_Predicate>
