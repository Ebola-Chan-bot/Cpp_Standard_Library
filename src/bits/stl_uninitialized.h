...
#define _GLIBCXX_USE_ASSIGN_FOR_INIT(T, U) \
					   ...
					   const _Tp &__x)
	{
		...
		const bool __can_fill = _GLIBCXX_USE_ASSIGN_FOR_INIT(_ValueType, const _Tp &);
...
#undef _GLIBCXX_USE_ASSIGN_FOR_INIT
	...
	struct __uninitialized_default_n_1
	{
		...
		_GLIBCXX20_CONSTEXPR static _ForwardIterator
	...
	__uninitialized_default_n(_ForwardIterator __first, _Size __n)
	{
		...
		return __uninitialized_default_n_1 < __is_trivial(_ValueType) && __can_fill > ::
																						  __uninit_default_n(__first, __n);
	}
	...
	uninitialized_move_n(_InputIterator __first, _Size __count,
						 _ForwardIterator __result)
	{
		auto __res = std::__uninitialized_copy_n_pair(_GLIBCXX_MAKE_MOVE_ITERATOR(__first),
													  __count, __result);
	...
	__relocate_object_a(_Tp *__restrict __dest, _Up *__restrict __orig,
						_Allocator &__alloc) noexcept(noexcept(std::allocator_traits<_Allocator>::construct(__alloc,
	...
	__relocate_a_1(_InputIterator __first, _InputIterator __last,
				   _ForwardIterator __result, _Allocator &__alloc) noexcept(noexcept(std::__relocate_object_a(std::addressof(*__result),
	...
	_GLIBCXX20_CONSTEXPR inline __enable_if_t<std::__is_bitwise_relocatable<_Tp>::value, _Tp *>
	...
	__relocate_a(_InputIterator __first, _InputIterator __last,
				 _ForwardIterator __result, _Allocator &__alloc) noexcept(noexcept(__relocate_a_1(std::__niter_base(__first),
