...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
		...
		: public std::iterator<std::random_access_iterator_tag, bool>
	{
		...
		_GLIBCXX20_CONSTEXPR _GLIBCXX_ALWAYS_INLINE void
		...
		operator<=>(const _Bit_iterator_base &__x, const _Bit_iterator_base &__y) noexcept
		{
			__x._M_assume_normalized();
			__y._M_assume_normalized();
...
#pragma GCC diagnostic pop
	...
	public:
		_GLIBCXX20_CONSTEXPR
		vector(vector &&__x, const __type_identity_t<allocator_type> &__a) noexcept(_Bit_alloc_traits::_S_always_equal())
	...
	public:
		...
		{
#if __cplusplus >= 201103L
			__glibcxx_assert(_Bit_alloc_traits::propagate_on_container_swap::value || _M_get_Bit_allocator() == __x._M_get_Bit_allocator());
#endif
...
#endif
#else
#include_next <bits/stl_bvector.h>
#endif