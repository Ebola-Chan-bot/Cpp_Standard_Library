...
namespace std _GLIBCXX_VISIBILITY(default)
{
  ...
  concept __eligible_tuple_like = __detail::__different_from<_Tp, _Tuple> && __tuple_like<_Tp> && (tuple_size_v<remove_cvref_t<_Tp>> == tuple_size_v<_Tuple>) && !ranges::__detail::__is_subrange<remove_cvref_t<_Tp>>;

  template <typename _Tp, typename _Pair>
  concept __eligible_pair_like = __detail::__different_from<_Tp, _Pair> && __pair_like<_Tp> && !ranges::__detail::__is_subrange<remove_cvref_t<_Tp>>;
#endif // C++23
  ...
  public:
    ...
    /// Default constructor
    template <enable_if_t<__not_<__and_<__is_implicitly_default_constructible<_T1>, __is_implicitly_default_constructible<_T2>>>() && is_default_constructible_v<_T1> _CSL_Parentheses11 && is_default_constructible_v<_T2> _CSL_Parentheses11, bool> = true>
    constexpr explicit pair()
        : first(), second()
    {
    }
    template <enable_if_t<__and_<__is_implicitly_default_constructible<_T1>, __is_implicitly_default_constructible<_T2>>() && is_default_constructible_v<_T1> _CSL_Parentheses11 && is_default_constructible_v<_T2> _CSL_Parentheses11, bool> = true>
    constexpr pair()
        : first(), second()
    {
    }
  ...
  private:
    ...
    _S_constructible()
    {
      return is_constructible_v<_T1, _U1> _CSL_Parentheses11 && is_constructible_v<_T2, _U2> _CSL_Parentheses11;
    }
    ...
    {
      return is_nothrow_constructible_v<_T1, _U1> _CSL_Parentheses11 && is_nothrow_constructible_v<_T2, _U2> _CSL_Parentheses11;
    }
    ...
    _S_convertible()
    {
      return is_convertible_v<_U1, _T1> _CSL_Parentheses11 && is_convertible_v<_U2, _T2> _CSL_Parentheses11;
    }
    ...
    _S_dangles()
    {
      ...
      return __reference_constructs_from_temporary(_T1, _U1 &&) || __reference_constructs_from_temporary(_T2, _U2 &&);
#else
      return false;
#endif
    }
  ...
  public:
    ...
    template <enable_if_t<!_S_convertible<const _T1 &, const _T2 &>() && _S_constructible<const _T1 &, const _T2 &>(), int> = 0>
    constexpr explicit pair(const _T1 &__x, const _T2 &__y) noexcept(_S_nothrow_constructible<const _T1 &, const _T2 &>())
        : first(__x), second(__y)
    {
    }
    template <enable_if_t<_S_convertible<const _T1 &, const _T2 &>() && _S_constructible<const _T1 &, const _T2 &>(), int> = 0>
    constexpr pair(const _T1 &__x, const _T2 &__y) noexcept(_S_nothrow_constructible<const _T1 &, const _T2 &>())
        : first(__x), second(__y)
    {
    }

    /// Constructor accepting two values of arbitrary types
    template <typename _U1 = _T1, typename _U2 = _T2, enable_if_t<(_S_constructible<_U1, _U2>()) && (!_S_dangles<_U1, _U2>()) && !_S_convertible<_U1, _U2>(), int> = 0>
    constexpr explicit pair(_U1 &&__x, _U2 &&__y) noexcept(_S_nothrow_constructible<_U1, _U2>())
        : first(std::forward<_U1>(__x)), second(std::forward<_U2>(__y))
    {
    }
    template <typename _U1 = _T1, typename _U2 = _T2, enable_if_t<(_S_constructible<_U1, _U2>()) && (!_S_dangles<_U1, _U2>()) && _S_convertible<_U1, _U2>(), int> = 0>
    constexpr pair(_U1 &&__x, _U2 &&__y) noexcept(_S_nothrow_constructible<_U1, _U2>())
        : first(std::forward<_U1>(__x)), second(std::forward<_U2>(__y))
    {
    }

    template <typename _U1 = _T1, typename _U2 = _T2, enable_if_t<(_S_constructible<_U1, _U2>()) && (_S_dangles<_U1, _U2>()) && !_S_convertible<_U1, _U2>(), int> = 0>
    constexpr explicit pair(_U1 &&, _U2 &&) = delete;
    template <typename _U1 = _T1, typename _U2 = _T2, enable_if_t<(_S_constructible<_U1, _U2>()) && (_S_dangles<_U1, _U2>()) && _S_convertible<_U1, _U2>(), int> = 0>
    constexpr pair(_U1 &&, _U2 &&) = delete;

    /// Converting constructor from a const `pair<U1, U2>` lvalue
    template <typename _U1, typename _U2, enable_if_t<(_S_constructible<const _U1 &, const _U2 &>()) && (!_S_dangles<_U1, _U2>()) && !_S_convertible<const _U1 &, const _U2 &>(), int> = 0>
    constexpr explicit pair(const pair<_U1, _U2> &__p) noexcept(_S_nothrow_constructible<const _U1 &, const _U2 &>())
        : first(__p.first), second(__p.second)
    {
    }
    template <typename _U1, typename _U2, enable_if_t<(_S_constructible<const _U1 &, const _U2 &>()) && (!_S_dangles<_U1, _U2>()) && _S_convertible<const _U1 &, const _U2 &>(), int> = 0>
    constexpr pair(const pair<_U1, _U2> &__p) noexcept(_S_nothrow_constructible<const _U1 &, const _U2 &>())
        : first(__p.first), second(__p.second)
    {
    }

    template <typename _U1, typename _U2, enable_if_t<(_S_constructible<const _U1 &, const _U2 &>()) && (_S_dangles<const _U1 &, const _U2 &>()) && !_S_convertible<const _U1 &, const _U2 &>(), int> = 0>
    constexpr explicit pair(const pair<_U1, _U2> &) = delete;
    template <typename _U1, typename _U2, enable_if_t<(_S_constructible<const _U1 &, const _U2 &>()) && (_S_dangles<const _U1 &, const _U2 &>()) && _S_convertible<const _U1 &, const _U2 &>(), int> = 0>
    constexpr pair(const pair<_U1, _U2> &) = delete;

    /// Converting constructor from a non-const `pair<U1, U2>` rvalue
    template <typename _U1, typename _U2, enable_if_t<(_S_constructible<_U1, _U2>()) && (!_S_dangles<_U1, _U2>()) && !_S_convertible<_U1, _U2>(), int> = 0>
    constexpr explicit pair(pair<_U1, _U2> &&__p) noexcept(_S_nothrow_constructible<_U1, _U2>())
        : first(std::forward<_U1>(__p.first)),
          second(std::forward<_U2>(__p.second))
    {
    }
    template <typename _U1, typename _U2, enable_if_t<(_S_constructible<_U1, _U2>()) && (!_S_dangles<_U1, _U2>()) && _S_convertible<_U1, _U2>(), int> = 0>
    constexpr pair(pair<_U1, _U2> &&__p) noexcept(_S_nothrow_constructible<_U1, _U2>())
        : first(std::forward<_U1>(__p.first)),
          second(std::forward<_U2>(__p.second))
    {
    }
    ...
    template <typename _U1, typename _U2, enable_if_t<(_S_constructible<_U1, _U2>()) && (_S_dangles<_U1, _U2>()) && !_S_convertible<_U1, _U2>(), int> = 0>
    constexpr explicit pair(pair<_U1, _U2> &&) = delete;
    template <typename _U1, typename _U2, enable_if_t<(_S_constructible<_U1, _U2>()) && (_S_dangles<_U1, _U2>()) && _S_convertible<_U1, _U2>(), int> = 0>
    ...
    constexpr explicit(!_S_convertible<_U1 &, _U2 &>())
        pair(pair<_U1, _U2> &__p) noexcept(_S_nothrow_constructible<_U1 &, _U2 &>())
        : first(__p.first), second(__p.second)
    {
    }
    ...
    constexpr explicit(!_S_convertible<const _U1, const _U2>())
        pair(const pair<_U1, _U2> &&__p) noexcept(_S_nothrow_constructible<const _U1, const _U2>())
    ...
    template <__eligible_pair_like<pair> _UPair>
      requires(_S_constructible_from_pair_like<_UPair>()) && (!_S_dangles_from_pair_like<_UPair>())
  ...
  private:
    ...
    _S_assignable()
    {
      return is_assignable_v<_T1 &, _U1> _CSL_Parentheses11 && is_assignable_v<_T2 &, _U2> _CSL_Parentheses11;
    }
    ...
    _S_const_assignable()
    {
      return is_assignable_v<const _T1 &, _U1> _CSL_Parentheses11 && is_assignable_v<const _T2 &, _U2> _CSL_Parentheses11;
    }
    ...
    {
      return is_nothrow_assignable_v<_T1 &, _U1> _CSL_Parentheses11 && is_nothrow_assignable_v<_T2 &, _U2> _CSL_Parentheses11;
    }
  ...
  public:
    template <enable_if_t<!_S_assignable<const _T1 &, const _T2 &>(), int> = 0>
    pair &operator=(const pair &) = delete;

    /// Copy assignment operator
    _GLIBCXX14_CONSTEXPR enable_if_t<_S_assignable<const _T1 &, const _T2 &>(), pair &>
    operator=(const pair &__p) noexcept(_S_nothrow_assignable<const _T1 &, const _T2 &>())
    {
      first = __p.first;
      second = __p.second;
      return *this;
    ...
    _GLIBCXX14_CONSTEXPR enable_if_t<_S_assignable<_T1, _T2>(), pair &>
    ...
    template <typename _U1, typename _U2>
    _GLIBCXX14_CONSTEXPR enable_if_t<_S_assignable<const _U1 &, const _U2 &>(), pair &>
    operator=(const pair<_U1, _U2> &__p) noexcept(_S_nothrow_assignable<const _U1 &, const _U2 &>())
    {
      first = __p.first;
      second = __p.second;
      return *this;
    ...
    template <typename _U1, typename _U2>
    _GLIBCXX14_CONSTEXPR enable_if_t<_S_assignable<_U1, _U2>(), pair &>
  ...
  public:
    ...
    template <typename _U1,
              __enable_if_t<__and_<__not_<is_reference<_U1>>,
                            ...
                            bool> = true>
    _GLIBCXX_DEPRECATED_PAIR_CTOR constexpr pair(_U1 &&__x, __zero_as_null_pointer_constant, ...)
    ...
    template <typename _U1,
              __enable_if_t<__and_<__not_<is_reference<_U1>>,
                            ...
                            bool> = false>
    _GLIBCXX_DEPRECATED_PAIR_CTOR explicit constexpr pair(_U1 &&__x, __zero_as_null_pointer_constant, ...)
        : first(std::forward<_U1>(__x)), second(nullptr)
    {
      __glibcxx_no_dangling_refs(_U1 &&, std::nullptr_t);
    }
    ...
    template <typename _U2,
              __enable_if_t<__and_<is_pointer<_T1>,
                                   ...
                                   is_convertible<_U2, _T2>>::value,
                            bool> = true>
    _GLIBCXX_DEPRECATED_PAIR_CTOR constexpr pair(__zero_as_null_pointer_constant, _U2 &&__y, ...)
    ...
    template <typename _U2,
              __enable_if_t<__and_<is_pointer<_T1>,
                            ...
                            bool> = false>
    _GLIBCXX_DEPRECATED_PAIR_CTOR explicit constexpr pair(__zero_as_null_pointer_constant, _U2 &&__y, ...)
        : first(nullptr), second(std::forward<_U2>(__y))
    {
      __glibcxx_no_dangling_refs(std::nullptr_t, _U2 &&);
    }
...
#pragma GCC diagnostic ignored "-Wunused-local-typedefs"
      typedef int _DanglingCheck1[__reference_constructs_from_temporary(_T1, const _U1 &) ? -1 : 1];
      typedef int _DanglingCheck2[__reference_constructs_from_temporary(_T2, const _U2 &) ? -1 : 1];
#pragma GCC diagnostic pop
  ...
  template <typename _T1, typename _T2>
  _GLIBCXX_NODISCARD inline _GLIBCXX_CONSTEXPR bool
