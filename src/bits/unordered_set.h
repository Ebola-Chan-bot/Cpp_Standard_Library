#pragma once
// SAM和ESP32虽然有unordered_set，但缺少contains方法，因此仍需覆盖
...
namespace std _GLIBCXX_VISIBILITY(default)
{
      ...
      public:
            ...
            unordered_set(unordered_set &&__uset,
                          const allocator_type &__a) noexcept(noexcept(_Hashtable(std::move(__uset._M_h), __a)))
             ...
             */
            void
            swap(unordered_set &__x) noexcept(noexcept(_M_h.swap(__x._M_h)))
            {
                  _M_h.swap(__x._M_h);
            }
      ...
      public:
            ...
            unordered_multiset(unordered_multiset &&__umset,
                               const allocator_type &__a) noexcept(noexcept(_Hashtable(std::move(__umset._M_h), __a)))
             ...
             */
            void
            swap(unordered_multiset &__x) noexcept(noexcept(_M_h.swap(__x._M_h)))
            {
                  _M_h.swap(__x._M_h);
            }
