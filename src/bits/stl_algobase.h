...
#define _GLIBCXX_MOVE3(_Tp, _Up, _Vp) std::copy(_Tp, _Up, _Vp)
  ...
  _GLIBCXX20_CONSTEXPR inline typename __gnu_cxx::__enable_if<!__is_scalar<_Tp>::__value, void>::__type
  ...
  _GLIBCXX20_CONSTEXPR inline typename __gnu_cxx::__enable_if<!__is_scalar<_Tp>::__value, _OutputIterator>::__type
      ...
      -> decltype(__comp(*__first1, *__first2))
  {
    ...
    if (!std::__is_constant_evaluated())
      if constexpr (same_as<_Comp, __detail::_Synth3way> || same_as<_Comp, compare_three_way>)
        if constexpr (__memcmp_ordered_with<_InputIter1, _InputIter2>)
        {
          ...
          if (__len)
          {
            ...
            const auto __c = __builtin_memcmp(&*__first1, &*__first2, __blen) <=> 0;
            if (__c != 0)
              return __c;
          }
          return __lencmp;
   ...
   */
  template <typename _InputIterator1, typename _InputIterator2>
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline pair<_InputIterator1, _InputIterator2>
