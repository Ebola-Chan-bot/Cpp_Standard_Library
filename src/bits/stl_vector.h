...
namespace std _GLIBCXX_VISIBILITY(default)
{
	...
	struct _Vector_base
	{
		...
		{
			_GLIBCXX20_CONSTEXPR
			template<enable_if_t<is_default_constructible<_Tp_alloc_type>::value, int> = 0>
...
#define _GLIBCXX_ASAN_ANNOTATE_BEFORE_DEALLOC
	...
	public:
		...
		_GLIBCXX20_CONSTEXPR
		vector(vector &&__rv, const __type_identity_t<allocator_type> &__m) noexcept(noexcept(
	...
	public:
		...
		_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const _Tp *
	...
	protected:
							...
							std::forward_iterator_tag)
		{
			...
			this->_M_impl._M_finish = std::__uninitialized_copy_a(__first, __last, __start, _M_get_Tp_allocator());
			this->_M_impl._M_start = __start;
		...
		{
			template <typename... _Args>
			_GLIBCXX20_CONSTEXPR explicit _Temporary_value(vector *__vec, _Args &&...__args) : _M_this(__vec)
			{
